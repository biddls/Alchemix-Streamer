...
contract StreamPayPro {

    address public streamPayCont;
    ...
    function accountCreation() external {
        ...
        */
        accounts[msg.sender] = new LazyStreamer(streamPayCont);
    }
...
//        uint256 _id = accounts[_account].pop();
        ...
        IStreamPay(streamPayCont).collectStream(_account, _id);
        // get how often its called
        // _secondsInDay = 86400
        ( , , , uint256 _freq, , ) = IStreamPay(streamPayCont).gets(_account, _id);
